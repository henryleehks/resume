...
export const AudioProvider = ({ children }: { children: React.ReactNode }) => {
  // #region agent log
  useEffect(() => {
    fetch('http://127.0.0.1:7242/ingest/0b577056-dd42-42d9-9d6e-dfb01d83f9b2',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({location:'src/hooks/useAudio.tsx:22',message:'AudioProvider rendered',timestamp:Date.now(),sessionId:'debug-session',hypothesisId:'A'})}).catch(()=>{});
  }, []);
  // #endregion
