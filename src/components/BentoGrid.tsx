...
export const GridItem = ({
  ...
  return (
    <motion.div
      ...
      className={`relative group overflow-hidden rounded-[2.5rem] border border-white/5 bg-white/[0.02] backdrop-blur-xl p-8 flex flex-col justify-between transition-all hover:bg-white/[0.04] hover:border-white/10 cursor-pointer ${className}`}
    >
